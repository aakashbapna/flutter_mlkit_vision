...
/// `barcodeDetector([BarcodeDetectorOptions options])` in [MlKitVision]:
///
/// ```dart
/// final MlKitVisionImage image =
///     MlKitVisionImage.fromFilePath('path/to/file');
///
/// final BarcodeDetector barcodeDetector =
///     MlKitVision.instance.barcodeDetector();
///
...
class BarcodeDetector {
  ...
  Future<List<Barcode>> processImage(MlKitVisionImage visionImage) async {
    assert(!_isClosed);

    _hasBeenOpened = true;
    final List<dynamic> reply =
    await MlKitVision.channel.invokeListMethod<dynamic>(
  ...
  Future<void> close() {
    ...
    _isClosed = true;
    return MlKitVision.channel.invokeMethod<void>(
