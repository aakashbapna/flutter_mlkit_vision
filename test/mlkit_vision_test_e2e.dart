...
void main() {
  ...
  testWidgets('Find barcodes in image', (WidgetTester tester) async {
    final String tmpFilename = await _loadImage('assets/test_text.png');
    final MlKitVisionImage visionImage =
    MlKitVisionImage.fromFilePath(tmpFilename);

    List<Barcode> barcodes;

    barcodes = await MlKitVision.instance.barcodeDetector()
